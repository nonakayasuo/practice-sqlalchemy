...
class Customer(db.Model):
    ...
    customer_unit_price = db.Column(db.Integer)

    def __init__(self, customer_id, customer_name, customer_unit_price):
...
class Purchase_detail(db.Model):
    ...
    item_id = db.Column(
        db.String, db.ForeignKey("items.item_id"), primary_key=True
    )
    customer_quantity = db.Column(db.Integer, nullable=False)

    def __init__(self, purchase_id, item_id, customer_quantity):
